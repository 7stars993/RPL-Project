...
<div class="menu-page">
  ...
  <nav class="side-nav">
    <ul class="nav-links">
      ...
      <li class="<?= isset($_GET['kat']) && $_GET['kat'] == "Sarapan" ? "active" : ""; ?>"><a href="menu.php?kat=Sarapan">Sarapan</a></li>
      <li class="<?= isset($_GET['kat']) && $_GET['kat'] == "Daging" ? "active" : ""; ?>"><a href="menu.php?kat=Daging">Daging</a></li>
      <li class="<?= isset($_GET['kat']) && $_GET['kat'] == "Ayam" ? "active" : ""; ?>"><a href="menu.php?kat=Ayam">Ayam</a></li>
      <li class="<?= isset($_GET['kat']) && $_GET['kat'] == "Ikan" ? "active" : ""; ?>"><a href="menu.php?kat=Ikan">Ikan</a></li>
      <li class="<?= isset($_GET['kat']) && $_GET['kat'] == "Minuman" ? "active" : ""; ?>"><a href="menu.php?kat=Minuman">Minuman</a></li>
    </ul>
  </nav>
  <!-- Side Nav End -->
